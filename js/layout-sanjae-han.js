...
const LAYOUT_SANJAEHAN_A = { key:'A', name:'일반내역',
  ...
  F(171,8,'an','진료개시일','CCYYMMDD'),
  F(179,16,'an','진료기간','CCYYMMDD+CCYYMMDD(From+To)'),
  F(195,3,'n','실진료일수','입원은 입원일수, 통원은 내원일수',null,'money'),
  F(198,3,'n','퇴원약투약일수','입원시 퇴원당일 처방 투여일수',null,'money'),
  F(201,31,'an','내원일','통원시 내원일=1, 비내원일=0'),
  F(232,16,'an','중환자실입원','CCYYMMDD+CCYYMMDD'),
  F(248,3,'n','중환자실입원일수','',null,'money'),
  ...
  F(253,1,'an','치료구분','최종 진료일 산재근로자 상태',{'1':'치유','2':'사망','3':'요양중 사망','4':'전원','5':'계속'}),
  F(254,2,'an','간병범위','',{'01':'두 손가락 상실 등으로 식사 불가','02':'실명 등으로 일상동작 불가','03':'뇌손상으로 의식혼미·착란','04':'신경계·정신장해로 의사소통 불가','05':'체표 35%이상 화상','06':'견인장치·석고붕대로 동작 불가','07':'배뇨배변 곤란·욕창방지 체위변경 필요','08':'신체허약으로 일상동작 불가','09':'수술 등으로 거동제한','10':'그 밖에 제1~9호에 준하는 사람'}),
  F(256,10,'n','기본진료약제특정재료I','종별가산율 미적용',null,'money'),
  F(266,10,'n','진료행위료II','종별가산율 적용',null,'money'),
  F(276,10,'n','청구액','소계+가산금액(10원미만 절사)',null,'money'),
  F(286,3,'n','가산율','건강보험 종별가산율에 산재 요양급여 산정기준 적용',null,'money'),
]};
...
const 산재한방목번호맵 = {
  '01':{'01':'초진','02':'재진','03':'기타','04':'가정간호기본방문료','05':'선택진료비'},
  '02':{'01':'일반','02':'내과,정신과','03':'중환자실','04':'상급병실','05':'기타','06':'기본식대','07':'가산식대'},
  '03':{'01':'내복약','02':'처방·조제·복약지도료'},
  '04':{'01':'침술','02':'구술','03':'부항술','04':'처치료','05':'기타'},
  '05':{'01':'양도락검사','02':'맥전도검사','03':'경락기능검사','04':'기타'},
  '06':{'01':'이학요법료'},
  '51':{'01':'간병료'},
  '52':{'01':'선택진료료(특별진찰 시 발생한 전체 항목 진료비에 대한 합)'},
  '57':{'01':'발급·확인수수료'},
  '58':{'01':'이송료'},
  '60':{'01':'첩약','02':'탕전료'},
  '99':{'01':'기타'},
...
const LAYOUT_SANJAEHAN_C = { key:'C', name:'진료내역',
  ...
  F(1,10,'an','청구번호',''),
  F(11,5,'an','명세서일련번호',''),
  F(16,2,'an','항','항번호',산재한방항번호코드,null,10),
  F(18,2,'an','목','목번호(항별 하위코드)',null,null,10),
  F(20,4,'n','줄번호','1~9999',null,null,10),
  F(24,1,'an','구분','코드구분',{'1':'수가','2':'준용수가','3':'약가','8':'치료재료'},null,7),
...
const LAYOUT_SANJAEHAN_E = { key:'E', name:'특정내역',
  ...
  F(1,10,'an','청구번호',''),
  F(11,5,'an','명세서일련번호',''),
  F(16,1,'an','발생단위구분','',{'1':'명세서','2':'진료내역 줄번호단위'}),
